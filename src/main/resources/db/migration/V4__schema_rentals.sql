...
CREATE TABLE equipment_rentals (
    ...
    reviewed_by          BIGINT,
    status               ENUM('PENDING_REVIEW','APPROVED','PICKED_UP','REJECTED','CANCELLED',
                              'PENDING_PAYMENT','PAID','ACTIVE','OVERDUE','RETURNED')
                         NOT NULL DEFAULT 'PENDING_REVIEW',
    payment_method       ENUM('NONE','ONLINE','CASH','BANK_TRANSFER') NOT NULL DEFAULT 'NONE',
    payment_status       ENUM('NONE','ONLINE_PENDING','ONLINE_PAID',
                              'CASH_PENDING','CASH_PAID',
                              'BANK_TRANSFER_PENDING','BANK_TRANSFER_PAID',
                              'PENALTY_PAID')
...
CREATE TABLE payments (
    ...
    paid_amount         BIGINT,
    payment_type        ENUM('ONLINE','CASH','BANK_TRANSFER') NOT NULL,
