...
public class EquipmentController {
    ...
    @PostMapping("/main")
    public ResponseEntity<EquipmentListResponse> addMainEquipment(
    ...
    @PutMapping("/main/{id}")
    public ResponseEntity<EquipmentListResponse> updateMainEquipment(
    ...
    public ResponseEntity<EquipmentListResponse> deleteMainEquipment(@PathVariable Long id) {
        return ResponseEntity.ok(equipmentService.deleteMainEquipment(id));
    }

    // ── Sub Equipment ─────────────────────────────────────────────────────────

    @PostMapping("/sub")
    public ResponseEntity<EquipmentListResponse> addSubEquipment(
    ...
    @PutMapping("/sub/{id}")
    public ResponseEntity<EquipmentListResponse> updateSubEquipment(
            @PathVariable Long id,
            @Valid @RequestBody SubEquipmentRequest request) {
    ...
    public ResponseEntity<EquipmentListResponse> deleteSubEquipment(@PathVariable Long id) {
        return ResponseEntity.ok(equipmentService.deleteSubEquipment(id));
    }
}
