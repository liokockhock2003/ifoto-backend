    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtFilter)
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/equipment/main/*/statuses").hasRole("EQUIPMENT_COMMITTEE")
                        .requestMatchers(HttpMethod.GET, "/api/v1/equipment/sub/*/quantity-holds").hasRole("EQUIPMENT_COMMITTEE")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/events/my").hasAnyRole("HIGH_COMMITTEE", "EVENT_COMMITTEE")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/event-equipment-requests/event/**").hasAnyRole("EVENT_COMMITTEE", "EQUIPMENT_COMMITTEE")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/event-equipment-requests/*").hasRole("EVENT_COMMITTEE")
                        .requestMatchers(HttpMethod.GET, "/api/v1/event-equipment-requests").hasRole("EQUIPMENT_COMMITTEE")
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/event-equipment-requests/**").hasRole("EQUIPMENT_COMMITTEE")
                        .requestMatchers(HttpMethod.POST, "/api/v1/event-equipment-requests/trigger-active").hasRole("EQUIPMENT_COMMITTEE")
                        // Reports
